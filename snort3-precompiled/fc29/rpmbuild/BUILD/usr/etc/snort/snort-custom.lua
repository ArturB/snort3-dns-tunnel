...
if ( not lua_path ) then
    package.path = '/usr/local/snort/include/snort/lua/?.lua;?;'
end
...
if ( not conf_dir ) then
    conf_dir = '/usr/local/snort/etc/snort'
end
...
appid =
{
    ...
    app_detector_dir = '/root/openappid'
}
...
ips =
{
    ...
    include = '/usr/local/snort/etc/snort/snort3-community.rules'
}

-- use these to configure additional rule actions
react = { }
reject = { reset = "both", control = "host" }
rewrite = { }
